...
@section('content')
    ...
    <div class="lg:ml-[250px]" style="calendar-wrapper max-width: 900px; margin-bottom: 230px;">
        ...
        <br><br>
        <div id="event-modal" class="relative w-full bg-white z-[99] hidden shadow-lg overflow-visible mr-8 scale-90">
                ...
                <div class="modal-content flex mb-4 w-full">
                    <div>
                        ...
                        <div class="mt-6">
                            <div class="flex flex-row flex-grow p-2 mb-6 border border-dashed border-gray-900/25 rounded-lg">
                                <svg class="toolbar cursor-pointer" onclick="toggleSearch(event)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#6a7282"><path d="M360-240ZM40-160v-112q0-34 17.5-62.5T104-378q62-31 126-46.5T360-440q32 0 64.5 3.5T489-425q-13 17-22.5 35.5T451-351q-23-5-45.5-7t-45.5-2q-56 0-111 13.5T140-306q-9 5-14.5 14t-5.5 20v32h323q4 22 11 42t18 38H40Zm320-320q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 66-47 113t-113 47Zm400-160q0 66-47 113t-113 47q-11 0-28-2.5t-28-5.5q27-32 41.5-71t14.5-81q0-42-14.5-81T544-792q14-5 28-6.5t28-1.5q66 0 113 47t47 113Zm-400 80q33 0 56.5-23.5T440-640q0-33-23.5-56.5T360-720q-33 0-56.5 23.5T280-640q0 33 23.5 56.5T360-560Zm0-80Zm320 440q34 0 56.5-20t23.5-60q1-34-22.5-57T680-360q-34 0-57 23t-23 57q0 34 23 57t57 23Zm0 80q-66 0-113-47t-47-113q0-66 47-113t113-47q66 0 113 47t47 113q0 23-5.5 43.5T818-198L920-96l-56 56-102-102q-18 11-38.5 16.5T680-120Z"/></svg>
                                <div class="h-[25px] w-0.5 bg-gray-200 ml-2 mr-2"></div>
                                <svg class="toolbar cursor-pointer" onclick="toggleLabel(event)" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#6a7282"><path d="M480-160v-80h120l180-240-180-240H160v200H80v-200q0-33 23.5-56.5T160-800h440q19 0 36 8.5t28 23.5l216 288-216 288q-11 15-28 23.5t-36 8.5H480Zm-10-320ZM200-120v-120H80v-80h120v-120h80v120h120v80H280v120h-80Z"/></svg>
                            </div>
                        </div>
                        <div id="modal-label-input-container" class="hidden relative mb-6 border border-dashed border-gray-900/25 rounded-lg">
                    ...
                    <div class="flex-grow">
                        <div id="drop-zone" data-event-id=""
                            class="mt-2 ml-4 flex-grow h-full justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10 text-center text-[#cccccc] overflow-y-scroll"
