					...
					<div class="border-b border-gray-900/10 pb-12">
						...
						<div class="grid grid-cols-1 lg:grid-cols-2 lg:col-span-2 gap-x-6 gap-y-8">
							...
							<div class="lg:col-span-1 lg:col-start-1">
								<x-input.form-input class="h-8" type="text" name="first_name" id="firstName" label="First Name" 
								...
								<x-input.form-input class="h-8" type="text" name="last_name" id="lastName" label="Last Name" 
								...
								<x-input.form-input class="h-8" type="email" name="email" id="email" label="Email" 
								...
								<x-input.upload-photo label="Upload / Change Profile Picture" id="profilePicture" name="profile_picture" 
							...
							<div class="lg:col-span-1 lg:col-start-2">
								<x-input.form-input class="h-8" type="tel" name="phone" id="phone" label="Phone Number" 
								...
								<x-input.select-dropdown class="h-8" name="country" id="country" label="Country" 
								...
								<x-input.select-dropdown class="h-8" name="gender" id="gender" label="Gender" 
								...
								<x-input.form-input class="h-8" type="password" name="password" id="password" label="Password" />
								@error('password')
									<span class="text-red-600 text-sm">{{ $message }}</span>
								@enderror
								<br>
						
								<x-input.form-input class="h-8" type="password" name="password_confirmation" id="repeatPassword" 
